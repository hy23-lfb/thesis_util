function h_imoverlay(B,F,climF,climB,cmap,alpha, out_filename,haxes)
% https://in.mathworks.com/matlabcentral/fileexchange/42904-imoverlay
...
[out_filepath, name, ext] = fileparts(out_filename);
saveas(f, [out_filepath '\overlay\' name ext]);
clear f;
close all;
end