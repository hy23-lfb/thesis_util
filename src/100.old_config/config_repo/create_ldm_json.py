...
if spec.platform == 'nt':
    ...
    data_file_path = """{
    "img_list": "/work/scratch/yogeshappa/00.masterarbeit_dataset/06.condor/test.txt",
    "atlas_file": "/work/scratch/yogeshappa/00.masterarbeit_dataset/00.atlas/np-scaled-channel/npz/np_atlas_scaled.npz",
    "atlas_landmarks": "/work/scratch/yogeshappa/00.masterarbeit_dataset/00.atlas/np-scaled-channel/npz/np_atlas_scaled_landmark.npz",
    "model_dir": "/work/scratch/yogeshappa/03.masterarbeit_out/ladmark_distance_condor","""
...
with open("Y:\\repo\Masterarbeit\src\config_ldm.json", "w") as outfile:
